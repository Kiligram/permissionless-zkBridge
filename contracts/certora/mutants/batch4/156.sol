...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    function syncCommitteeRootByPeriod(uint256 _period) external payable returns (bytes32) {
        ...
        /// RequireMutation(`msg.value == SYNC_COMMITTEE_ROOT_PRICE` |==> `true`) of: `require(msg.value == SYNC_COMMITTEE_ROOT_PRICE, "Incorrect fee for sync committee root");`
        require(true, "Incorrect fee for sync committee root");
