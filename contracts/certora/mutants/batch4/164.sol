...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    function syncCommitteeRootToPoseidon(bytes32 _root) external payable returns (bytes32) {
        ...
        /// RequireMutation(`msg.value == SYNC_COMMITTEE_ROOT_PRICE` |==> `false`) of: `require(msg.value == SYNC_COMMITTEE_ROOT_PRICE, "Incorrect fee for sync committee root");`
        require(false, "Incorrect fee for sync committee root");
