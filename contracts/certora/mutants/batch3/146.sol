...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    function _updateHeader(HeaderUpdate calldata headerUpdate) internal {
        ...
        /// DeleteExpressionMutation(`_slot2block[headerUpdate.finalizedHeader.slot] = headerUpdate.blockNumber` |==> `assert(true)`) of: `_slot2block[headerUpdate.finalizedHeader.slot] = headerUpdate.blockNumber;`
        assert(true);
