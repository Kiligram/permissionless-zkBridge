...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    function _updateHeader(HeaderUpdate calldata headerUpdate) internal {
        ...
        /// AssignmentMutation(`headerUpdate.blockNumber` |==> `0`) of: `_slot2block[headerUpdate.finalizedHeader.slot] = headerUpdate.blockNumber;`
        _slot2block[headerUpdate.finalizedHeader.slot] = 0;
