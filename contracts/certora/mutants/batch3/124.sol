...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    function updateSyncCommittee(
        ...
        /// RequireMutation(`_syncCommitteeRootByPeriod[nextPeriod] == 0` |==> `true`) of: `require(_syncCommitteeRootByPeriod[nextPeriod] == 0, "Next sync committee was already initialized");`
        require(true, "Next sync committee was already initialized");
