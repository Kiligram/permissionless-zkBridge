...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    function updateSyncCommittee(
        ...
        /// DeleteExpressionMutation(`_syncCommitteeRootToSubmitter[update.nextSyncCommitteeRoot] = msg.sender` |==> `assert(true)`) of: `_syncCommitteeRootToSubmitter[update.nextSyncCommitteeRoot] = msg.sender;`
        assert(true);
