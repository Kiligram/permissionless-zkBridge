...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    function updateSyncCommittee(
        ...
        /// RequireMutation(`_syncCommitteeRootByPeriod[nextPeriod] == 0` |==> `false`) of: `require(_syncCommitteeRootByPeriod[nextPeriod] == 0, "Next sync committee was already initialized");`
        require(false, "Next sync committee was already initialized");
