...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    function withdrawIncentive() external nonReentrant {
        /// RequireMutation(`relayerToIncentive[msg.sender] != 0` |==> `false`) of: `require(relayerToIncentive[msg.sender] != 0, "No incentive to withdraw");`
        require(false, "No incentive to withdraw");
