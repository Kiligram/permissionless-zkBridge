...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    function _updateHeader(HeaderUpdate calldata headerUpdate) internal {
        ...
        /// AssignmentMutation(`headerUpdate.executionStateRoot` |==> `0`) of: `_executionStateRoots[headerUpdate.finalizedHeader.slot] = headerUpdate.executionStateRoot;`
        _executionStateRoots[headerUpdate.finalizedHeader.slot] = 0;
