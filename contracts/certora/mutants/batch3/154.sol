...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    function syncCommitteeRootByPeriod(uint256 _period) external payable returns (bytes32) {
        /// RequireMutation(`_syncCommitteeRootByPeriod[_period] != bytes32(0)` |==> `false`) of: `require(_syncCommitteeRootByPeriod[_period] != bytes32(0), "Sync committee root not found for this period");`
        require(false, "Sync committee root not found for this period");
