...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    function updateSyncCommittee(
        ...
        /// AssignmentMutation(`update.nextSyncCommitteeRoot` |==> `0`) of: `_syncCommitteeRootByPeriod[nextPeriod] = update.nextSyncCommitteeRoot;`
        _syncCommitteeRootByPeriod[nextPeriod] = 0;
