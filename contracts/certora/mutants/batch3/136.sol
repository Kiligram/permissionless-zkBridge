...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    function _updateHeader(HeaderUpdate calldata headerUpdate) internal {
        require(
            /// SwapArgumentsOperatorMutation(`headerUpdate.finalizedHeader.slot > headSlot` |==> `headSlot > headerUpdate.finalizedHeader.slot`) of: `headerUpdate.finalizedHeader.slot > headSlot,`
