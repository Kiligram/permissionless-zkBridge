...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    function _updateHeader(HeaderUpdate calldata headerUpdate) internal {
        ...
        /// DeleteExpressionMutation(`_executionStateRoots[headerUpdate.finalizedHeader.slot] = headerUpdate.executionStateRoot` |==> `assert(true)`) of: `_executionStateRoots[headerUpdate.finalizedHeader.slot] = headerUpdate.executionStateRoot;`
        assert(true);
