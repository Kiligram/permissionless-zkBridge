...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    function withdrawIncentive() external nonReentrant {
        ...
        /// AssignmentMutation(`0` |==> `1`) of: `relayerToIncentive[msg.sender] = 0; // Reset the incentive balance to 0`
        relayerToIncentive[msg.sender] = 1; // Reset the incentive balance to 0
    }
