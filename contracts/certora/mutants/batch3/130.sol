...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    function updateSyncCommittee(
        ...
        /// DeleteExpressionMutation(`_syncCommitteeRootByPeriod[nextPeriod] = update.nextSyncCommitteeRoot` |==> `assert(true)`) of: `_syncCommitteeRootByPeriod[nextPeriod] = update.nextSyncCommitteeRoot;`
        assert(true);
