...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    modifier onlyProposer() {
        ...
        /// RequireMutation(`relayerToBalance[msg.sender] > 0` |==> `true`) of: `require(relayerToBalance[msg.sender] > 0, "Address is not whitelisted");`
        require(true, "Address is not whitelisted");
