...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    function withdrawIncentive() external nonReentrant {
        /// DeleteExpressionMutation(`require(relayerToIncentive[msg.sender] != 0, "No incentive to withdraw")` |==> `assert(true)`) of: `require(relayerToIncentive[msg.sender] != 0, "No incentive to withdraw");`
        assert(true);
