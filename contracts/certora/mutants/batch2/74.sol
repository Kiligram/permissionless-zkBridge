...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    modifier onlyProposer() {
        ...
        /// SwapArgumentsOperatorMutation(`relayerToBalance[msg.sender] > 0` |==> `0 > relayerToBalance[msg.sender]`) of: `require(relayerToBalance[msg.sender] > 0, "Address is not whitelisted");`
        require(0 > relayerToBalance[msg.sender], "Address is not whitelisted");
