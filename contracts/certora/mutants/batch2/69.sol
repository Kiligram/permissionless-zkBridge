...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    modifier onlyProposer() {
        /// RequireMutation(`msg.sender == currentProposer || currentProposerExpiration < block.timestamp` |==> `false`) of: `require(msg.sender == currentProposer || currentProposerExpiration < block.timestamp, "Only proposer can call this function");`
        require(false, "Only proposer can call this function");
