...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    modifier onlyProposer() {
        /// RequireMutation(`msg.sender == currentProposer || currentProposerExpiration < block.timestamp` |==> `true`) of: `require(msg.sender == currentProposer || currentProposerExpiration < block.timestamp, "Only proposer can call this function");`
        require(true, "Only proposer can call this function");
