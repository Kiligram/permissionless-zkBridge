...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    modifier onlyProposer() {
        ...
        /// DeleteExpressionMutation(`require(relayerToBalance[msg.sender] > 0, "Address is not whitelisted")` |==> `assert(true)`) of: `require(relayerToBalance[msg.sender] > 0, "Address is not whitelisted");`
        assert(true);
