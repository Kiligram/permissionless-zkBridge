...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    modifier onlyProposer() {
        ...
        /// RequireMutation(`relayerToBalance[msg.sender] > 0` |==> `false`) of: `require(relayerToBalance[msg.sender] > 0, "Address is not whitelisted");`
        require(false, "Address is not whitelisted");
