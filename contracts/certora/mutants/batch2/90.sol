...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    function withdrawIncentive() external nonReentrant {
        /// RequireMutation(`relayerToIncentive[msg.sender] != 0` |==> `true`) of: `require(relayerToIncentive[msg.sender] != 0, "No incentive to withdraw");`
        require(true, "No incentive to withdraw");
