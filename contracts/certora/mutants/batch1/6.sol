...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    function joinRelayerNetwork() external payable {
        ...
        /// RequireMutation(`relayerToBalance[msg.sender] == 0` |==> `false`) of: `require(relayerToBalance[msg.sender] == 0, "Address already whitelisted");`
        require(false, "Address already whitelisted");
