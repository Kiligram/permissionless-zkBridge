...
contract EthereumLightClient is ILightClientGetter, ILightClientSetter, ReentrancyGuard  {
    ...
    function _removeRelayerFromWhitelist(address _address) internal {
        /// SwapArgumentsOperatorMutation(`relayerToBalance[_address] > 0` |==> `0 > relayerToBalance[_address]`) of: `require(relayerToBalance[_address] > 0, "Address is not whitelisted");`
        require(0 > relayerToBalance[_address], "Address is not whitelisted");
